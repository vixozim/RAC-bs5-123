        ...
        o = function() {
            for (var e = i.scrollTop(), o = s.height(), a = o - r, c = e > a ? a - e : 0, p = 0; p < n.length; p++) {
                var d = n[p],
                    ...
                    h = l - d.topSpacing - c;
                if (d.stickyWrapper.css("height", d.stickyElement.outerHeight()), h >= e) null !== d.currentTop && (d.stickyElement.css("width", "").css("position", "").css("top", ""), d.stickyElement.trigger("sticky-end", [d]).parent().removeClass(d.className), d.currentTop = null);
                else {
